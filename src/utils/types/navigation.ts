...
export type RootScreenPrams = {
    ...
    P_ADD_SCORE: undefined;
};
type RootStackRouteProp<T extends keyof RootScreenPrams> = RouteProp<RootScreenPrams, T>;
type RootNativeStackNavigationProp<T extends keyof RootScreenPrams> = T extends "S_MAIN"
...
type LoginStackRouteProp<T extends keyof LoginStackParam> = RouteProp<LoginStackParam, T>;
type LoginNativeStackNavigationProps<T extends keyof LoginStackParam> = CompositeNavigationProp<
...
type MainTabStackRouteProp<T extends keyof MainTabParam> = RouteProp<MainTabParam, T>;
type MainTabNativeStackNavigationProps<T extends keyof MainTabParam> = CompositeNavigationProp<
...
export type DrawerParam = {
    ...
    D_INVITE_MEMBER: undefined;
    D_SCORE_HISTORY: undefined;
};
type DrawerStackRouteProp<T extends keyof DrawerParam> = RouteProp<DrawerParam, T>;
type DrawerNativeStackNavigationProps<T extends keyof DrawerParam> = CompositeNavigationProp<
    NativeStackNavigationProp<RootScreenPrams, "S_MAIN">,
